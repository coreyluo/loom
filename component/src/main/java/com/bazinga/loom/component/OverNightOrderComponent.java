...
public class OverNightOrderComponent {
    ...
    public void overNight(){
        ...
        for (LoomStockPool loomStockPool : loomStockPools) {
            ...
            if(byUniqueKey.getBid1Volume() < (byUniqueKey.getAsk1Volume()+ byUniqueKey.getAsk2Volume())/5){
            ...
            if(byUniqueKey.getAsk1Volume() < (byUniqueKey.getBid1Volume()+ byUniqueKey.getBid2Volume())/5){
                log.info("单子薄不挂往下顺延 stockCode{}",byUniqueKey.getStockCode());
