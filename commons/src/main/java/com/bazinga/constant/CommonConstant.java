...
public class CommonConstant {
    ...
    public static int LOOP_TIMES = 3;
    ...
    public static final BigDecimal EXACTLY_ONE = new BigDecimal("1");

    public static final BigDecimal ONE_POINT_ZERO_SIX = new BigDecimal("1.06");
    ...
    public static final BigDecimal DECIMAL_TEN_THOUSAND = new BigDecimal("10000");

    public static final BigDecimal DECIMAL_HUNDRED_BILLION = new BigDecimal("10000000000");
    public static final BigDecimal DECIMAL_POINT_EIGHT_BILLION = new BigDecimal("80000000");
    public static final BigDecimal DECIMAL_298W = new BigDecimal("2980000");
    ...
    public static final Long HALF_ONE_MILLION = 500000L;
    ...
    public static final String SH_INDEX_CODE= "00000000";
}
